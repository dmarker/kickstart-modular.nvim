...
-- Diagnostic keymaps
kmap('n', '[d', vim.diagnostic.goto_prev, { desc = 'Go to previous [D]iagnostic message' })
kmap('n', ']d', vim.diagnostic.goto_next, { desc = 'Go to next [D]iagnostic message' })
kmap('n', '<leader>e', vim.diagnostic.open_float, { desc = 'Show diagnostic [E]rror messages' })
...
-- bufferline
kmap('n', '<S-l>', '<cmd> BufferLineCycleNext <CR>') --"  cycle next buffer"
kmap('n', '<S-h>', '<cmd> BufferLineCyclePrev <CR>') --"  cycle prev buffer"
kmap('n', '<leader>l', '<cmd> BufferLineMoveNext <CR>') --"  cycle next buffer"
kmap('n', '<leader>h', '<cmd> BufferLineMovePrev <CR>') --"  cycle prev buffer"
